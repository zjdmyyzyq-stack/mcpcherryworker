...
建库:2026-08-03 | 最近更新:2026-08-13(第 7 次补录:batch-0348/0372full 126 篇 + △ 词条分类改造) | 来源:外文智库、外军官网、外文期刊;中译依据:国内官方媒体、军方媒体、外交部/国防部表态、国内核心期刊与高校智库
合并说明:本文件由【workbuddy 原始对照表(第一~九章)】+【龙虾翻译实战补充(第十章)】+【核实修正记录(第十一章)】合并而成,2026-08-03 建库,此后每次翻译实战持续补录,头部「最近更新」随补录同步刷新。
...
2. 凡国内无可靠定译的,一律列入「第十二章 暂未划分」表待核,不冒充通行译名(△ = 暂未划分,不收录为正式词条)。
...
4. 新增时按流程:查官方用法定级(◎/○/暂未划分)→补进第十(或对应)章或第十二章暂未划分表→第十一章加核实记录→同步 GitHub + Cloudflare KV 两端。
...
| Epic Fury | "史诗狂怒"行动 | ○ | 2026 美对伊军事行动代号(Operation Epic Fury)。依据:《"史诗狂怒"第11天》等多篇(11.5 已建议升○,官方媒体用例未见) |
...
### 10.15 美国国内灾害与人口政策术语（2026-08-13 批 0373 补录）
...
### 11.6 2026-08-13 △ 词条分类处置

114 条 △ 全部处置完毕（含文首规则行 1 条），升◎ 1 / 升○ 39 / 暂未划分 73，正文不再保留 △ 词条。处置依据：第一轮检索分类判定表（glossary-delta-classify-20260813

### 11.7 2026-08-13 补录批次核实记录（batch-0373）

- 本批 2 篇美国国内政策译文（卡内基 IDP 文、布鲁金斯移民/人口文）实战新增术语 29 条，多为美国国内机构/调查/计划名，无军事冲突词；分级：◎官方定译（FEMA/HUD/人口普查局/城市研究所等政府机构或知名智库）、○学界通行；R3 Program、Transitional Sheltering Assistance、gap period、urban core counties 4 条国内无通行定译，按新规则列入第十二章暂未划分表。
- 核实依据：译文对应原文（carnegieendowment.org 2026-04-14 Kayly Ober 文；brookings.edu 2026-04-21 William H. Frey 文）；机构名以官网/联合国文件为准。
- 注：本批补录由主会话手动规范化执行（子代理通道故障未落盘成功），10.15 物理位置在第十章末尾。.md),本轮仅按表执行改造,未重新检索。

---

## 十二、暂未划分(△ 类,2026-08-13 起规则:不收录为正式词条)
